...
export default function Page() {
  return (
    <Layout title="Casa Nomad" pageName="case-casa-nomad">
      ...
      <div className="max-w-[1400px] mx-auto">
        <h1 className="text-[32px] md:text-[40px] lg:text-[48px] font-medium tracking-tighter-custom uppercase mb-2"
          data-split-text>Casa Nomad</h1>
        <p className="text-[16px] font-medium tracking-tight-custom text-muted mb-12" data-reveal-up>Weaving artisan stories
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
          <div data-reveal-up>
            ...
            <p className="text-[16px] font-medium tracking-tight-custom leading-[1.2]">Арт-дирекшн, цифровой маркетинг.</p>
          </div>
          <div data-reveal-up>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-[15px] font-normal tracking-tight-custom uppercase text-muted mb-2">Client</p>
                <p className="text-[16px] font-medium tracking-tight-custom">Casa Nomad</p>
              </div>
              <div>
                <p className="text-[15px] font-normal tracking-tight-custom uppercase text-muted mb-2">Location</p>
                <p className="text-[16px] font-medium tracking-tight-custom">Oaxaca, Mexico</p>
              </div>
              <div>
        ...
        <div className="mt-12 max-w-2xl" data-reveal-up>
          ...
          <p className="text-[16px] font-medium tracking-tight-custom leading-[1.2]">Глобальный бренд, вдохновлённый
            ремесленными традициями.</p>
        </div>
      </div>
    </section>
