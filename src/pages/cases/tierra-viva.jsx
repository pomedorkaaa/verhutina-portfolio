...
export default function Page() {
  return (
    <Layout title="Tierra Viva" pageName="case-tierra-viva">
      ...
      <div className="max-w-[1400px] mx-auto">
        <h1 className="text-[32px] md:text-[40px] lg:text-[48px] font-medium tracking-tighter-custom uppercase mb-2"
          data-split-text>Tierra Viva</h1>
        <p className="text-[16px] font-medium tracking-tight-custom text-muted mb-12" data-reveal-up>Breathing new life into
          an organic market</p>
        <div className="overflow-hidden aspect-video" data-reveal-up>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
          <div data-reveal-up>
            ...
            <p className="text-[16px] font-medium tracking-tight-custom leading-[1.2]">Брендинг, визуальная идентичность,
              стратегия.</p>
          </div>
          <div data-reveal-up>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-[16px] font-medium tracking-tight-custom">Tierra Viva</p>
              </div>
              <div>
                <p className="text-[15px] font-normal tracking-tight-custom uppercase text-muted mb-2">Location</p>
                <p className="text-[16px] font-medium tracking-tight-custom">Buenos Aires</p>
              </div>
              <div>
                <p className="text-[15px] font-normal tracking-tight-custom uppercase text-muted mb-2">Year</p>
                <p className="text-[16px] font-medium tracking-tight-custom">2024</p>
              </div>
              <div>
        ...
        <div className="mt-12 max-w-2xl" data-reveal-up>
          ...
          <p className="text-[16px] font-medium tracking-tight-custom leading-[1.2]">Полный ребрендинг органического рынка —
            от логотипа до упаковки.</p>
        </div>
      </div>
    </section>
